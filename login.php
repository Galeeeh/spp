...
if (isset($_POST['username'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        $_SESSION['petugas'] = mysqli_fetch_array($query);
        ...
        $_SESSION['petugas'] = mysqli_fetch_array($query1);
        $_SESSION['waktu_login'] = time();
        echo '<script>alert("Anda Berhasil Login"); location.href="index.php";</script>';
    } else {
        echo  '<script>alert("username/nisn atau password salah"); location.href="login.php";</script>';
    }
}
                                ...
                                <div class="m-sm-3">
                                    <form method="post">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="username" placeholder="Enter Username/Nisn" />
                                        </div>
                                        <div class="mb-3">
